...
\begin{itemize}[noitemsep,topsep=0pt]
  \item Project aimed at dissecting the genetic control of autumn dormancy in autotetraploid alfalfa \textit{Medicago sativa} using quantitative and population genetic approaches.
\end{itemize}
%
\\
%
...
\item{Web Design, 2016 UCD Plant Breeding Symposium (\href{http://plantbreeding2016.ucdavis.edu}{plantbreeding2016.ucdavis.edu})}
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
